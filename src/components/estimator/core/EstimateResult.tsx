...
import { formatCurrency, formatSquareFootage, formatTimeEstimate } from '../utils/calculations';
...
export default function EstimateResult({ estimateData, formData, onBackToForm }: EstimateResultProps) {
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-white">Estimate Results</h2>
        {onBackToForm && (
          <button 
