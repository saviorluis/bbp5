...
const NavLinks = () => {
  return (
    <>
      ...
      <Link href="/services" className="text-primary hover:text-secondary font-medium transition-colors">
        SOLUTIONS
      </Link>
      <Link href="/about-us" className="text-primary hover:text-secondary font-medium transition-colors">
        ABOUT US
      </Link>
      <Link href="/contact-us" className="text-primary hover:text-secondary font-medium transition-colors">
        CONTACT US
      </Link>
...
const MobileNavLinks = () => {
  return (
    <>
      ...
      <Link href="/services" className="text-primary hover:text-secondary font-medium py-3 border-b">
        SOLUTIONS
      </Link>
      <Link href="/about-us" className="text-primary hover:text-secondary font-medium py-3 border-b">
        ABOUT US
      </Link>
      <Link href="/contact-us" className="text-primary hover:text-secondary font-medium py-3 border-b">
        CONTACT US
      </Link>
