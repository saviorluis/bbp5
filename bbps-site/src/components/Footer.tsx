        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base">
              <li>
                <Link href="/services/janitorial" className="hover:text-accent transition-colors">
                  Janitorial Cleaning
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/services/office" className="hover:text-accent transition-colors">
                  Office Cleaning
                </Link>
              </li>
              <li>
                <Link href="/services/airbnb" className="hover:text-accent transition-colors">
                  Airbnb Cleaning
                </Link>
              </li>
              <li>
                <Link href="/services/post-construction" className="hover:text-accent transition-colors">
